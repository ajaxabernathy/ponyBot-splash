...
export default function Home() {
  return (
    <main>
      <div className='md:flex landing_body min-h-screen min-w-screen'>
        <section className=''>
          <div className='text-center items-center tracking-tighter font-extrabold leading-[1.2] text-[120px] md:text-[250px] md:block flex flex-col md:mt-0 md:text-left ml-6 -space-y-8 py-16 md:py-0'>
            ...
            <div className='flex py-[100px] w-3/4 nav_text_light text-slate-50 md:hidden'>
              WatchDog's command-line interface is bringing Kubernetes cluster
              monitoring to your terminal.
            </div>
          </div>
        </section>
      </div>
